...
export const verifySubscription = asyncHandler(async (req, res, next) => {
  ...
  const generatedSignature = crypto
    ...
    .digest('hex');
console.log(" ye hai re baba=>>>>>>" ,generatedSignature);
...
export const cancelSubscription = asyncHandler(async (req, res, next) => {
  ...
  await user.save();
  await Payment.deleteMany({ razorpaySubscriptionId: subscriptionId });
...
//Problem in facing removing payment frim database . after course calcination everything is fine but payment is not removing from database.
// Need to check the payment model and payment controller for removing payment from database.